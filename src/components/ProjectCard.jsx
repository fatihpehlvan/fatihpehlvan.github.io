...
export default function ProjectCard({ project, isDark }) {
  return (
    <div className={`group p-6 ${isDark ? 'bg-gray-800/60 border-gray-700' : 'bg-white/90 border-pink-200'} backdrop-blur-sm rounded-3xl shadow-md border hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-[1.02] relative`}>
